...
For more details on writing automatic rules, please see the [rules spec](https://github.com/promethiumchain/go-promethium/blob/master/cmd/clef/rules.md).
