...
)](https://godoc.org/github.com/promethiumchain/go-promethium)
[![Go Report Card](https://goreportcard.com/badge/github.com/promethiumchain/go-promethium)](https://goreportcard.com/report/github.com/promethiumchain/go-promethium)
[![Travis](https://travis-ci.org/promethiumchain/go-promethium.svg?branch=master)](https://travis-ci.org/promethiumchain/go-promethium)
...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/promethiumchain/go-promethium/wiki/Building-Ethereum) on the wiki.
...
[CLI Wiki page](https://github.com/promethiumchain/go-promethium/wiki/Command-Line-Options)),
 ...
 * Start up `promethium`'s built-in interactive [JavaScript console](https://github.com/promethiumchain/go-promethium/wiki/JavaScript-Console),
   (via the trailing `console` subcommand) through which you can invoke all official [`web3` methods](https://github.com/ethereum/wiki/wiki/JavaScript-API)
   as well as `promethium`'s own [management APIs](https://github.com/promethiumchain/go-promethium/wiki/Management-APIs).
...
and [`promethium` specific APIs](https://github.com/promethiumchain/go-promethium/wiki/Management-APIs)).
...
more complex changes though, please check up with the core devs first on [our gitter channel](https://gitter.im/promethiumchain/go-promethium)
...
Please see the [Developers' Guide](https://github.com/promethiumchain/go-promethium/wiki/Developers'-Guide)
