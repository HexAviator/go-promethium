...
Audit reports are published in the `docs` folder: https://github.com/promethiumchain/go-promethium/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `promethium` | 20170425 | [pdf](https://github.com/promethiumchain/go-promethium/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/promethiumchain/go-promethium/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
